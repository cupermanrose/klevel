...
FileMemory::FileMemory(const int a_pagesize, string filename, RtreeNodeEntry* (*a_fromMem)(const char* a_mem, int& a_len, const int a_dimen, const bool a_pt), const bool a_new) :
